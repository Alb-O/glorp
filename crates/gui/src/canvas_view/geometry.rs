...
pub const fn scene_origin() -> Point {
	Point::new(24.0, 28.0)
}

pub fn scene_viewport_size(bounds: Size) -> Size {
	Size::new(
...
pub(super) const fn clamp_scroll(scroll: Vector, max_scroll: Vector) -> Vector {
...
const fn scene_content_width(metrics: EditorViewportMetrics, layout_width: f32) -> f32 {

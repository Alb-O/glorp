...
#[cfg(test)]
pub struct DocumentLayoutTestSpec {
	pub text: Arc<str>,
	pub wrapping: crate::types::WrapChoice,
	pub max_width: f32,
...
pub fn resolve_font_names_from_buffer(font_system: &FontSystem, buffer: &Buffer) -> Arc<[(fontdb::ID, Arc<str>)]> {
	buffer
		.layout_runs()
...
#[cfg(test)]
impl DocumentLayout {
	pub fn build_for_test(font_system: &mut FontSystem, text: &str, config: SceneConfig) -> Self {

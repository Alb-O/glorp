...
pub const CALLS: &[CallDefinition] = &[
	...
	call(
		...
		true,
		Some(call_type(
			"crate::EditorMotionInput",
			&[named_type("EditorMotionInput", "crate::EditorMotionInput")],
		)),
		call_type(
			"crate::GlorpOutcome",
			&[named_type("GlorpOutcome", "crate::GlorpOutcome")],
	...
	call(
		...
		true,
		Some(call_type(
			"crate::EditorModeInput",
			&[named_type("EditorModeInput", "crate::EditorModeInput")],
		)),
		call_type(
			"crate::GlorpOutcome",
			&[named_type("GlorpOutcome", "crate::GlorpOutcome")],
	...
	call(
		...
		true,
		Some(call_type(
			"crate::EditorHistoryInput",
			&[named_type("EditorHistoryInput", "crate::EditorHistoryInput")],
		)),
		call_type(
			"crate::GlorpOutcome",
			&[named_type("GlorpOutcome", "crate::GlorpOutcome")],
	...
	call(
		...
		call_type(
			...
			&[named_type("EditorStateView", "crate::EditorStateView")],
		),
	),
	call(
		"Capabilities",

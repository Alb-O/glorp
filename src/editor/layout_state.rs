...
impl EditorLayout {
	...
	pub(super) fn apply_incremental_edit(&mut self, font_system: &mut FontSystem, text: &str, edit: &TextEdit) {
		let started = Instant::now();
		self.clear_snapshot();
...
pub(super) fn edit_changes_line_structure(text: &str, edit: &TextEdit) -> bool {
